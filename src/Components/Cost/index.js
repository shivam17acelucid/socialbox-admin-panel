...
function Cost() {
    ...
    const handleUpdateCostOfUniqueInfluencer = () => {
        let url = `http://65.0.110.147:4000/setInfluencerCost`;
        fetch((url), {
            method: 'PUT',
            headers: {
    ...
    const handleUpdateReelCost = () => {
        ...
        let url = `http://65.0.110.147:4000/setCalculateCostForReel`;
        fetch((url), {
            method: 'POST',
            headers: {
                'Content-type': 'application/json; charset=UTF-8',
    ...
    const handleUpdatePostCost = () => {
        ...
        let url = `http://65.0.110.147:4000/setCalculateCostForPosts`;
        fetch((url), {
            method: 'POST',
            headers: {
                'Content-type': 'application/json; charset=UTF-8',
    ...
    const handleUpdateStoryCost = () => {
        ...
        let url = `http://65.0.110.147:4000/setCalculateCostForStories`;
        fetch((url), {
            method: 'POST',
            headers: {
                'Content-type': 'application/json; charset=UTF-8',
    ...
    const handleUpdateSwipeUpCost = () => {
        ...
        let url = `http://65.0.110.147:4000/setCalculateCostForSwipeupStories`;
        fetch((url), {
            method: 'POST',
            headers: {
                'Content-type': 'application/json; charset=UTF-8',
    ...
    const handleUpdateVideoCost = () => {
        ...
        let url = `http://65.0.110.147:4000/setCalculateCostForVideos`;
        fetch((url), {
            method: 'POST',
            headers: {
                'Content-type': 'application/json; charset=UTF-8',
    ...
    const handleUpdateIgtvCost = () => {
        ...
        let url = `http://65.0.110.147:4000/setCalculateCostForIgtv`;
        fetch((url), {
            method: 'POST',
            headers: {
                'Content-type': 'application/json; charset=UTF-8',
